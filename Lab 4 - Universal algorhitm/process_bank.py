...
class ProcessBank(Element):
    ...
    def __init__(self, delay, channels=1):
        ...
        self.system_tasks, self.processor_state = 0, 0
        self.failure = 0
    ...
    def statistics(self, delta):
        ...
        for i in range(self.channel):
            ...
            self.processor_state += self.state[i]
        self.system_tasks = (self.processor_state + self.queue) * delta
