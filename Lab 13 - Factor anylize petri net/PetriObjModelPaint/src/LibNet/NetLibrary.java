...
public static PetriNet CreateNetUntitled1() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
	ArrayList<PetriP> d_P = new ArrayList<>();
	ArrayList<PetriT> d_T = new ArrayList<>();
	ArrayList<ArcIn> d_In = new ArrayList<>();
	ArrayList<ArcOut> d_Out = new ArrayList<>();
	d_P.add(new PetriP("P1",3));
	d_P.add(new PetriP("P2",0));
	d_P.add(new PetriP("P1",1));
	d_P.add(new PetriP("P3",0));
	d_P.add(new PetriP("P5",0));
        d_P.get(4).setMark((d_P.get(0).getMark())- (d_P.get(2).getMark()));
	d_T.add(new PetriT("T1",2.0));
	d_In.add(new ArcIn(d_P.get(0),d_T.get(0),1));
	d_In.add(new ArcIn(d_P.get(2),d_T.get(0),1));
	d_In.get(1).setInf(true);
	d_In.add(new ArcIn(d_P.get(4),d_T.get(0),2));
