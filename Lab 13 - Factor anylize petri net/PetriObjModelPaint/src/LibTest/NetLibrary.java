...
public class NetLibrary {
	...
	/**
	 * Creates Petri net that describes the dynamics of system of the mass service
	...
	/**
	 * Creates Petri net that describes the route choice with given probabilities
	 *
	 ...
	 * @throws PetriObj.ExceptionInvalidNetStructure
	 */
	public static PetriNet CreateNetFork(int numOfWay, double[] probabilities)
			throws ExceptionInvalidTimeDelay, ExceptionInvalidNetStructure {
	...
	public static PetriNet CreateNetGenerator2(double d)
	...
	public static PetriNet CreateNetConsistency(double forDelay, double readDelay, double modifyDelay,
			double writeDelay) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
		ArrayList<PetriP> d_P = new ArrayList<>();
		ArrayList<PetriT> d_T = new ArrayList<>();
		ArrayList<ArcIn> d_In = new ArrayList<>();
		ArrayList<ArcOut> d_Out = new ArrayList<>();
